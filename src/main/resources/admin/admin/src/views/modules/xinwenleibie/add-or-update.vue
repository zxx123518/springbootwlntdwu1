<template>
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="新闻类别" prop="xinwenleibie">
					<el-input v-model="ruleForm.xinwenleibie" placeholder="新闻类别" clearable  :readonly="ro.xinwenleibie"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="新闻类别" prop="xinwenleibie">
					<el-input v-model="ruleForm.xinwenleibie" placeholder="新闻类别" readonly></el-input>
				</el-form-item>
			</template>
